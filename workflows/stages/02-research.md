...
**GPT-4 Mini delegation:** Sparrow can summarize long documents or format findings, but NOT evaluate technical decisions. Use `${AEGIS_SPARROW_PATH:-sparrow} 'summarize: ...'` with timeout and graceful fallback.
